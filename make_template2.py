...
headers=["職員ID ★","パスワード ★","姓（苗字）★","名（名前）★","部署 ★","入社年月日","保有資格","認定研修","部署長","管理部署","在籍状態","役職名"]
...
tips=["例: 001, E001, 158","例: pass001","例: 山田","例: 太郎","例: ホーム","例: 2020-04-01","複数は|区切り\n例: 介護福祉士|社会福祉士","複数は|区切り\n例: 実務者研修","部署長は「1」\nそれ以外は空欄","複数は|区切り\n例: ホーム|デイ","退職者は「退職」\nそれ以外は空欄","例: 主任, 管理者"]
...
for i,w in enumerate([10,12,12,12,12,14,22,22,8,14,10,12],1):
